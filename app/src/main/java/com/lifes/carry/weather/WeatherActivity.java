...
public class WeatherActivity extends AppCompatActivity {
    ...
    public SwipeRefreshLayout swiperRefresh;
...
//            表示拿到当前活动的DecorView   下面表示活动的布局显示在状态栏的上面
...
//
        ...
        swiperRefresh =(SwipeRefreshLayout) findViewById(R.id.swipe_refresh);
        swiperRefresh.setProgressBackgroundColorSchemeResource(R.color.colorPrimary);
